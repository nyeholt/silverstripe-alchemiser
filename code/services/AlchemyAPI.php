...
class AlchemyAPI {
	...
	*/
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function entities($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function keywords($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function concepts($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  * The response, already converted from JSON to a PHP object. 
	*/
	public function sentiment($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	*/
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function text($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function text_raw($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function author($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function language($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function title($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function relations($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object.
	*/
	public function category($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function feeds($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	/**
	  ...
	  *	The response, already converted from JSON to a PHP object. 
	*/
	public function microformats($flavor, $data, $options = array()) {
		//Make sure this request supports the flavor
	...
	*/
	public function imageExtraction($flavor, $data, $options = array()) {
	  	//Make sure this request supports the flavor
	 ...
	 */
	public function taxonomy($flavor, $data, $options = array()) {	
	  //Make sure this request supports the flavor	
	 ...
	 */
	public function combined($flavor, $data, $options = array()) {
	  //Make sure this request supports the flavor
